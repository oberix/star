# -*- coding: utf-8 -*-
lm_registri_iva = {
        'DATE': [0, 'c', 'Data registrazione',None,None],
        'M_NAME': [1, 'c', 'Numero protocollo',None,None],
        'DATE_DOC': [2, 'c', 'Data documento',None,None],
        'M_REF': [3, 'c', 'Numero documento',None,None],
        'PARTNER': [4, 'c', 'Controparte',None,None],
        'TNAME': [5, 'c', 'Tipo imposta',None,None],
